...
<body>
    ...
    <div class="q1">
        <div class="qs">
            ...
            <p>SELECT e.Ssn,e.Fname,e.Lnamee,e.Address FROM employee e RIGHT OUTER JOIN employee d ON e.ssn=d.ssn; </p>
            <br>
        </div>
    <?php
    ...
    $sql = "SELECT d.Ssn AS Employe,d.Super_ssn,e.Fname,e.Lname,e.Address FROM employee e RIGHT OUTER JOIN employee d ON e.Ssn=d.Super_ssn";
    ...
    <td>" . "Employee Address" ."&nbsp"."</td>

    </tr>";
    while($row = $result->fetch_assoc()) {
        echo "<tr>
        <td>" . $row["Employe"] . "&nbsp"."</td>
        <td>" . $row["Super_ssn"] ."&nbsp"."</td>
