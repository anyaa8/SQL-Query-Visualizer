...
<body>
    ...
    <div class="q1">
        <div class="qs">
            ...
            <p>SELECT e.Fname, e.Lname, e.Address , d.Dname FROM employee e INNER JOIN 
    department d ON d.Dnumber=e.Dno WHERE d.Dname='Research'</p>
            <br>
        </div>
    <?php
    ...
    $sql = "SELECT e.Fname, e.Lname, e.Address , d.Dname FROM employee e INNER JOIN 
    department d ON d.Dnumber=e.Dno WHERE d.Dname='Research'";
