...
<div class="head">
    ...
    <div class="q1">
        <div class="qs">
        <p>Ques. Delete the row with Ssn value 888665555 from the Employee table.</p>
            <p>DELETE FROM EMPLOYEE WHERE Ssn = '888665555';</p><br>
        </div>
    ...
    $sqll = "DELETE FROM employee WHERE Ssn='888665555'";
